            ...
            <div style = "width:300px; border: solid 1px #333333; " align = "left">
                ...
                <div style = "margin:30px">
                    ...
                    <form action = "register" method = "post">
                        ...
                        <input type = "password" name = "confirm_password" id="confirm_password" class = "box" onkeyup="checkPass(); return false;"/><br/><br />
                        <label id="confirm_message" style="width:300px"></label><br /><br />
